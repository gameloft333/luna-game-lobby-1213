...
import { signUpWithEmail, sendVerificationEmail } from '../../lib/firebase/auth/methods';
...
export function SignUpForm({ onSuccess, onSignInClick }: SignUpFormProps) {
  ...
  const [useEmailLink, setUseEmailLink] = React.useState(false);
